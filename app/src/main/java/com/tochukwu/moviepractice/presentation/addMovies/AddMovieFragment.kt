...
import com.tochukwu.moviepractice.databinding.FragmentAddMovieBinding
...
import com.tochukwu.moviepractice.util.hideKeyboard
                ...
                when(it.status) {
                    Status.SUCCESS -> {
                        ...
                        it.data?.let { movieList ->
                            addMovieListAdapter.submitList(movieList)
                        }
                    }
