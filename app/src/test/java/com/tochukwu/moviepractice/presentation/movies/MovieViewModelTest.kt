...
import com.tochukwu.moviepractice.MainCoroutineRule
import com.tochukwu.moviepractice.getOrAwaitValueTest
import com.tochukwu.moviepractice.repository.FakeMovieRepository
import com.tochukwu.moviepractice.util.Status
...
class MovieViewModelTest{
    ...
    @Test
    fun `get movies from network with empty query return error`(){
        viewModel.getMovies("")
...
/**
    @Test
    fun `get  movies with network error returns failure`(){
        viewModel.getMovies("query")
 ...
 **/
    ...
    @Test
    fun `get movies before network request return loading then success`() = runBlocking{
